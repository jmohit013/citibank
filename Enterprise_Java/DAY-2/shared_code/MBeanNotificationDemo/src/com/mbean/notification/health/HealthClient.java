...
public class HealthClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        echo("\n>>> Perform operations on Health MBean <<<");

        ObjectName mbeanName = new ObjectName("com.mbean.notification.health:type=Health");

        HealthMBean mbeanProxy =
            JMX.newMBeanProxy(mbsc, mbeanName, HealthMBean.class, true);

        echo("\nAdd notification listener...");
	mbsc.addNotificationListener(mbeanName, listener, new HealthNotificationFilter(), null);


        mbeanProxy.setBloodPressure(250);
        ...
        //
        echo("\nBlood pressure = " + mbeanProxy.getBloodPressure());
