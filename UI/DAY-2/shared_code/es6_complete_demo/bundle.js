...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scoping = __webpack_require__(333);

	var _enhanced_object_properties = __webpack_require__(334);

	var _arrow_functions = __webpack_require__(335);

	var _destructuring_assignment = __webpack_require__(336);

	var _extended_parameter_handling = __webpack_require__(337);

	var _template_literals = __webpack_require__(338);

	var _animal = __webpack_require__(339);

	var _animal2 = _interopRequireDefault(_animal);

	var _promises = __webpack_require__(340);

	var _organization = __webpack_require__(341);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _constants.testConstants)();
...
/***/ function(module, exports) {
	...
	exports.testComputedPropertyName = testComputedPropertyName;
	exports.testMethodProperties = testMethodProperties;
	exports.testCopyProperties = testCopyProperties;

	function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

	function testComputedPropertyName() {
	    var _orderObj_;
	    ...
	    var idKey = 'id';
	    var titleKey = 'title';
	    var _orderObj_2 = (_orderObj_ = {}, _defineProperty(_orderObj_, idKey, oId), _defineProperty(_orderObj_, titleKey, oTitle), _orderObj_); //ES6
	    var accountObj = { accId: 444 };

	    //var titleKey = 'title';
	    var orderObj = _defineProperty({ id: 111 }, titleKey, 'My order');
	    console.log("orderObj.titleKey", orderObj.titleKey);
	    console.log("orderObj.title", orderObj.title);
	}

	function testMethodProperties() {
	    ...
	    var orderObj_2 = { id: 222, title: 'Your order',
	        printOrder: function printOrder() {
	            console.log(this.id, ' - ', this.title);
	        }
	    };
	...
	function testCopyProperties() {
	    ...
	    var newOrderObj = Object.assign(targetOrderObj, orderObj, orderObj_2);
...
/***/ function(module, exports) {
	...
	exports.testWithoutArrowFunctions = testWithoutArrowFunctions;
	exports.testArrowFunctions = testArrowFunctions;
	function testWithoutArrowFunctions() {
	    var nos = [4, 7, 2, 8];
	    ...
	    var square_nos = nos.map(function (no) {
	        return no * no;
	    }); //Arrow function as expression body
	    square_nos = nos.map(function (no) {
	        return no * no;
	    ...
	    var facebookUser = {
	        ...
	        printFirends: function printFirends() {
	            var _this = this;
	            ...
	            */
	            ...
	            //ES6 code
	            this.friends.map(function (friend) {
	                return console.log(_this.user, ' knows ', friend);
	            });
	        }
	    };
	...
	function testArrowFunctions() {
	    ...
	    var facebookUser = {
	        ...
	        printFirends: function printFirends() {
	            ...
	            this.friends.map(function (friend) {
	                return console.log(_this2.user, ' knows ', friend);
	            });
	        }
	    };
	    facebookUser.printFirends();
...
/***/ function(module, exports) {
	...
	function testDestructuringAssignment() {
	    ...
	    var no_first = nos[0],
	        no_last = nos[3]; //De-structuring an array

	    var _ref = [10, 20, 30, 40],
	        x = _ref[0],
	        y = _ref[3];

	    console.log(x, y);

	    var _id$title$price = { id: 546, title: 'Fruit Delivery', price: 5200.85 },
	        id = _id$title$price.id,
	        title = _id$title$price.title;
	    ...
	    var _cust$address = cust.address,
	        city = _cust$address.city,
	        state = _cust$address.state; //Deep matching
	    ...
	    var _list$ = list[0],
	        ...
	        d = list[3]; //Fail-soft de-structuring with default values.
...
/***/ function(module, exports) {
	...
	function testExtendedParameterHandling() {
	    ...
	    spreadOperator.apply(undefined, nos); //ES6
	}

	function greet() {
	    var msg = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Hello";
	    var name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "Tom";

	    console.log(msg, name);
	}

	function restParametersFunc(x) {
...
/***/ function(module, exports) {
	...
	exports.testTemplateLiterals = testTemplateLiterals;
...
/***/ function(module, exports) {
	...
	exports.testPromises_2 = testPromises_2;
	exports.testPromises = testPromises;
	exports.testAllPromises = testAllPromises;
	exports.testPromises_3 = testPromises_3;
	function testPromises_2() {
	    var p = Promise.resolve("foo");
	    p.then(function (res) {
	        return console.log("p response: ", res);
	    });
	    ...
	    p2.then(function (response) {
	        return console.log("p2 response: ", response);
	    });
	...
	function testAllPromises() {
	    ...
	    Promise.race([p, p2]).then(function (promiseResponse) {
	        console.log(promiseResponse);
	    });
	}

	function testPromises_3() {
	    var myPromise = Promise.resolve(50);
	    console.log('myPromise: ', myPromise);

	    myPromise.then(function (response) {
	        return console.log('Response received: ', response);
	    });

	    myPromise = new Promise(function (resolve, reject) {
	        return setTimeout(function () {
	            return reject("Pizza order rejected");
	        }, 4000);
	    });

	    myPromise.then(function (response) {
	        return console.log('Pizza order response received: ', response);
	    }).catch(function (error) {
	        return console.log('Handling the error: ', error);
	    });
	    ...
	    var pr_1 = new Promise(function (resolve, reject) {
	        setTimeout(function () {
	            return reject("After 5 seconds resolve: FOO");
	        }, 5000);
	    });
	    var pr_2 = new Promise(function (resolve, reject) {
	        setTimeout(function () {
	            return resolve("After 15 seconds resolve: BAR");
	        }, 15000);
	    });
	    Promise.race([pr_1, pr_2]).then(function (response) {
...
/***/ function(module, exports) {
	...
	exports.testOrganization = testOrganization;
	...
	var Manager = exports.Manager = function (_Employee) {
		_inherits(Manager, _Employee);

		function Manager(id, name, salary, incentive) {
			_classCallCheck(this, Manager);

			var _this = _possibleConstructorReturn(this, (Manager.__proto__ || Object.getPrototypeOf(Manager)).call(this, id, name, salary));
		...
		_createClass(Manager, [{
			key: 'toString',
			value: function toString() {
				return _get(Manager.prototype.__proto__ || Object.getPrototypeOf(Manager.prototype), 'toString', this).call(this) + '-' + this.incentive;
			}
		}]);
	...
	function testOrganization() {
		var emp = new Manager(12, 'Tonny', 12000, 3000);
